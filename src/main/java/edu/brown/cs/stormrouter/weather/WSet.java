...
public final class WSet {
  ...
  private static final double SNOW_INTEN_MID_CUTOFF = 0.15 * Units.IN_TO_MM;
  // Celsius
  private static final double TEMP_CUTOFF_CEL = 40;
  // Kilometers
  private static final double VISIBILITY_HARD_CUTOFF = 0.40;
  private static final double VISIBILITY_SOFT_CUTOFF = 1.0;
  ...
  private static final int SNOW_HIGH_SCORE = 75;
  private static final int TEMP_HIGH_SCORE = 20;
  private static final int VISIBILITY_HARD_SCORE = 75;
  private static final int VISIBILITY_SOFT_SCORE = 30;
  ...
  public static int scoreWeather(TimePoint weather) {
    ...
    if (weather.getTemperature() > TEMP_CUTOFF_CEL) {
